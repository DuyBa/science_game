...
# MOUSEBUTTONDOWN to check if object was clicked and set drag = True (and remember offset 
# between mouse position and rectangle top-left corner)
...
while running:
    ...
    pygame.draw.rect(screen, RED, rectanglee)
    
    if rectangle.colliderect(rectanglee):
        print('a')
